...
CONTINENT_OVERRIDES: dict[str, str] = {
    ...
    "Mauritius": "Africa",
    "Madagascar": "Africa",
    # North American territories and Caribbean islands
    ...
    "Denmark/Greenland": "North America",  # Greenland is geographically North America
    # Catch-all
    "Unknown": "Unknown",
    "(tom)": "Unknown",
}
